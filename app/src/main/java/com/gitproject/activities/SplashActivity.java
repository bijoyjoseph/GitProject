    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 23) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, "Storage Permission needed to run this App", Toast.LENGTH_LONG).show();
            }
        }
        if (requestCode == AppConstants.STORAGE_PERMISSION_CODE) {
            ...
            if (perms.get(Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(SplashActivity.this, "Storage permission is required for this app", Toast.LENGTH_SHORT)
                        .show();
